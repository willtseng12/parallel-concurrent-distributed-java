...
//        }
        ...
        ReciprocalArraySumTask leftSum = new ReciprocalArraySumTask(0, mid, input);
        ReciprocalArraySumTask rightSum = new ReciprocalArraySumTask(mid, input.length, input);
        leftSum.fork();
        rightSum.compute();
        leftSum.join();
        sum = leftSum.getValue() + rightSum.getValue();

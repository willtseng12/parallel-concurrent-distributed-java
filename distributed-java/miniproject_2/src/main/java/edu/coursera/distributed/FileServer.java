...
//            throw new UnsupportedOperationException();
            ...
            String[] stringComponent = line.split(" ");
            String pathString = stringComponent[1];
            ...
            if (content == null) {
                replyHttp404(printWriter);
            } else {
                replyExistResponse(printWriter, content);
            }
            printWriter.close();
        }
    }

    private void replyExistResponse(PrintWriter printer, String content) {
    ...
    private void replyHttp404(PrintWriter printer) {
